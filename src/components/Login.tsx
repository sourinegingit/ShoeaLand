...
const Login = () => {
  return (
    ...
    <input type="text" placeholder="UserName..." className="pl-10 py-2 border border-gray-300 rounded-md w-full"/>
  </div>
        
  <div className="relative mt-4 flex items-center max-w-md mx-auto">
  <PiLockKeyBold className="absolute left-3 text-gray-500" />

    <input type="text" placeholder="password..." className="pl-10 py-2 border border-gray-300 rounded-md w-full"/>
  </div>
      
          <button type="submit" className="rounded-full mt-52 text-xl bg-black text-white w-full p-2">
            Sign In
          </button>
